...
### Duration by Type
- **Quick promo** (15–25s total): 2–3 scenes, fast-paced
- **Standard video** (30–50s total): 4–6 scenes, balanced pacing
- **Detailed showcase** (50–80s total): 6–10 scenes, thorough coverage

### Scene Duration Ranges
- Intro/Logo reveal: 5–7 seconds
- Text reveals (single message): 5–7 seconds
- Feature showcases: 6–9 seconds
- Stats/data displays: 6–8 seconds
- CTA/outro: 5–6 seconds
- Complex scenes (comparison, timeline): 7–10 seconds
...
3. **Feature Highlights** — 1–3 feature scenes (SplitScreenScene)
...
3. **Feature Deep Dives** — key features (SplitScreenScene)
...
4. **Values/Features** — what the brand stands for
